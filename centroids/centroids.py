...
#ImagemC = opening(ImagemC, disk(1))
...
detected_circles = cv2.HoughCircles(ImagemC,  
                   cv2.HOUGH_GRADIENT, 1, 7, param1 = 100, 
               param2 = 6, minRadius = 2, maxRadius = 5) 
